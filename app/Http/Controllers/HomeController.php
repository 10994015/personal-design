    ...
    public function index(){
        ...
        $jobs = [
            [
                ...
                'address'=>'桃園市桃園區',
                'contents'=>[
                    "<h2>1.室內設計：與客戶緊密合作，理解他們的風格偏好和實際需求，開發設計方案。這包括空間布局規劃、材料選擇、照明設計以及定制家具設計。</h2>",
                    "<h2>2.AI生成3D擬真圖：利用生成對抗網路，將2D設計草圖轉化為詳細的3D視覺效果圖，使客戶能夠在施工前快速的預覽多種設計及修改。</h2>",
                    "<h2>3.平面設計：為品牌創建視覺化系統，包括商標、名片、DM和數位廣告，強化品牌形象並提升市場溝通效果。</h2>",
                    "<h2>4.網站設計：從概念到實現，提供全面的網站設計和開發服務，包括響應式設計、用戶界面和用戶體驗設計，以及SEO優化。</h2>",
                    "<h2>5.伺服器架設：為企業建立安全、可靠的伺服器架構，支持網站運行和企業數據存儲，並提供持續的技術支持和維護。</h2>",
                ],
            ],
            [
                'date'=>'2023-至今',
